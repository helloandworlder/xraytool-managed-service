...
type SocketConfig struct {
	...
	// ReusePort allows a warmed replacement process to bind the same inbound
	// before the previous process drains established sessions.
	ReusePort     bool `protobuf:"varint,24,opt,name=reuse_port,json=reusePort,proto3" json:"reuse_port,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SocketConfig) GetReusePort() bool {
	if x != nil {
		return x.ReusePort
	}
	return false
...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\x04type\x18\x06 \x01(\tR\x04type\"\xe8\b\n" +
	...
	"\x17trusted_x_forwarded_for\x18\x17 \x03(\tR\x14trustedXForwardedFor\x12\x1d\n" +
	"\n" +
	"reuse_port\x18\x18 \x01(\bR\treusePort\"/\n" +
	"\n" +
	"TProxyMode\x12\a\n" +
	"\x03Off\x10\x00\x12\n" +
	"\n" +
