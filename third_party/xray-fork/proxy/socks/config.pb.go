...
type UserAccount struct {
	...
	UplinkLimitBps   uint64                 `protobuf:"varint,5,opt,name=uplink_limit_bps,json=uplinkLimitBps,proto3" json:"uplink_limit_bps,omitempty"`
	DownlinkLimitBps uint64                 `protobuf:"varint,6,opt,name=downlink_limit_bps,json=downlinkLimitBps,proto3" json:"downlink_limit_bps,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *UserAccount) GetUplinkLimitBps() uint64 {
	if x != nil {
...
func (x *UserAccount) GetDownlinkLimitBps() uint64 {
	if x != nil {
...
const file_proxy_socks_config_proto_rawDesc = "" +
	...
	"\x10uplink_limit_bps\x18\x05 \x01(\x04R\x0euplinkLimitBps\x12,\n" +
	"\x12downlink_limit_bps\x18\x06 \x01(\x04R\x10downlinkLimitBps\"\x89\x03\n" +
	"\fServerConfig\x127\n" +
