...
func (x *Account) GetBandwidthBps() uint64 {
	if x != nil {
...
func (x *Account) GetConnLimit() uint32 {
	if x != nil {
		return x.ConnLimit
	}
	return 0
...
const file_proxy_vless_account_proto_rawDesc = "" +
	...
	"\bsniffing\x18\x02 \x01(\v2!.xray.app.proxyman.SniffingConfigR\bsniffing\"\xca\x02\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\btestseed\x18\t \x03(\rR\btestseed\x12#\n" +
	"\rbandwidth_bps\x18\n" +
	" \x01(\x04R\fbandwidthBps\x12\x1d\n" +
	"\n" +
	"conn_limit\x18\v \x01(\rR\tconnLimitBR\n" +
