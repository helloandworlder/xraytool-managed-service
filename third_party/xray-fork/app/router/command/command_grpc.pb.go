...
const (
	...
	RoutingService_BatchAddRule_FullMethodName           = "/xray.app.router.command.RoutingService/BatchAddRule"
	RoutingService_BatchRemoveRule_FullMethodName        = "/xray.app.router.command.RoutingService/BatchRemoveRule"
	RoutingService_ListRule_FullMethodName               = "/xray.app.router.command.RoutingService/ListRule"
	RoutingService_ListRuleFull_FullMethodName           = "/xray.app.router.command.RoutingService/ListRuleFull"
)
...
type RoutingServiceClient interface {
	...
	BatchAddRule(ctx context.Context, in *BatchAddRuleRequest, opts ...grpc.CallOption) (*BatchRuleResponse, error)
	BatchRemoveRule(ctx context.Context, in *BatchRemoveRuleRequest, opts ...grpc.CallOption) (*BatchRuleResponse, error)
	ListRule(ctx context.Context, in *ListRuleRequest, opts ...grpc.CallOption) (*ListRuleResponse, error)
	ListRuleFull(ctx context.Context, in *ListRuleFullRequest, opts ...grpc.CallOption) (*ListRuleFullResponse, error)
}
...
func (c *routingServiceClient) BatchAddRule(ctx context.Context, in *BatchAddRuleRequest, opts ...grpc.CallOption) (*BatchRuleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchRuleResponse)
	err := c.cc.Invoke(ctx, RoutingService_BatchAddRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) BatchRemoveRule(ctx context.Context, in *BatchRemoveRuleRequest, opts ...grpc.CallOption) (*BatchRuleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchRuleResponse)
	err := c.cc.Invoke(ctx, RoutingService_BatchRemoveRule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingServiceClient) ListRuleFull(ctx context.Context, in *ListRuleFullRequest, opts ...grpc.CallOption) (*ListRuleFullResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListRuleFullResponse)
	err := c.cc.Invoke(ctx, RoutingService_ListRuleFull_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoutingServiceServer interface {
	...
	BatchAddRule(context.Context, *BatchAddRuleRequest) (*BatchRuleResponse, error)
	BatchRemoveRule(context.Context, *BatchRemoveRuleRequest) (*BatchRuleResponse, error)
	ListRule(context.Context, *ListRuleRequest) (*ListRuleResponse, error)
	ListRuleFull(context.Context, *ListRuleFullRequest) (*ListRuleFullResponse, error)
...
func (UnimplementedRoutingServiceServer) BatchAddRule(context.Context, *BatchAddRuleRequest) (*BatchRuleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchAddRule not implemented")
}
func (UnimplementedRoutingServiceServer) BatchRemoveRule(context.Context, *BatchRemoveRuleRequest) (*BatchRuleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchRemoveRule not implemented")
}
...
func (UnimplementedRoutingServiceServer) ListRuleFull(context.Context, *ListRuleFullRequest) (*ListRuleFullResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListRuleFull not implemented")
}
...
func _RoutingService_BatchAddRule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchAddRuleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).BatchAddRule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_BatchAddRule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).BatchAddRule(ctx, req.(*BatchAddRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoutingService_BatchRemoveRule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchRemoveRuleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).BatchRemoveRule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_BatchRemoveRule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).BatchRemoveRule(ctx, req.(*BatchRemoveRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoutingService_ListRuleFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListRuleFullRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingServiceServer).ListRuleFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingService_ListRuleFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingServiceServer).ListRuleFull(ctx, req.(*ListRuleFullRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoutingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchAddRule",
			Handler:    _RoutingService_BatchAddRule_Handler,
		},
		{
			MethodName: "BatchRemoveRule",
			Handler:    _RoutingService_BatchRemoveRule_Handler,
		},
		{
			MethodName: "ListRule",
		...
		{
			MethodName: "ListRuleFull",
			Handler:    _RoutingService_ListRuleFull_Handler,
		},
	},
