...
// BatchAddRule appends/inserts many routing rules over a single gRPC call so
// per-client route churn scales with node requests instead of per-rule round
// trips. Each config is one xray.app.router.Config. Operations apply in order;
// per-operation failures are reported instead of aborting the whole batch.
type BatchAddRuleRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *BatchAddRuleRequest) Reset() {
	*x = BatchAddRuleRequest{}
	mi := &file_app_router_command_command_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchAddRuleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchAddRuleRequest) ProtoMessage() {}

func (x *BatchAddRuleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchAddRuleRequest.ProtoReflect.Descriptor instead.
func (*BatchAddRuleRequest) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{17}
}

func (x *BatchAddRuleRequest) GetConfigs() []*serial.TypedMessage {
	if x != nil {
		return x.Configs
	}
	return nil
...
func (x *BatchAddRuleRequest) GetShouldAppend() bool {
	if x != nil {
		return x.ShouldAppend
	}
	return false
...
type BatchRemoveRuleRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RuleTags      []string               `protobuf:"bytes,1,rep,name=ruleTags,proto3" json:"ruleTags,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchRemoveRuleRequest) Reset() {
	*x = BatchRemoveRuleRequest{}
	mi := &file_app_router_command_command_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchRemoveRuleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchRemoveRuleRequest) ProtoMessage() {}

func (x *BatchRemoveRuleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchRemoveRuleRequest.ProtoReflect.Descriptor instead.
func (*BatchRemoveRuleRequest) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{18}
}

func (x *BatchRemoveRuleRequest) GetRuleTags() []string {
	if x != nil {
		return x.RuleTags
	}
	return nil
...
func (x *BatchRuleOperationResult) Reset() {
	*x = BatchRuleOperationResult{}
	mi := &file_app_router_command_command_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BatchRuleOperationResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchRuleOperationResult) ProtoMessage() {}

func (x *BatchRuleOperationResult) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchRuleOperationResult.ProtoReflect.Descriptor instead.
func (*BatchRuleOperationResult) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{19}
}

func (x *BatchRuleOperationResult) GetIndex() uint32 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *BatchRuleOperationResult) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *BatchRuleOperationResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type BatchRuleResponse struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Results       []*BatchRuleOperationResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BatchRuleResponse) Reset() {
	*x = BatchRuleResponse{}
...
func (x *BatchRuleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchRuleResponse) ProtoMessage() {}

func (x *BatchRuleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchRuleResponse.ProtoReflect.Descriptor instead.
func (*BatchRuleResponse) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{20}
}

func (x *BatchRuleResponse) GetResults() []*BatchRuleOperationResult {
	if x != nil {
		return x.Results
	}
	return nil
...
type ListRuleFullRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListRuleFullRequest) Reset() {
	*x = ListRuleFullRequest{}
	mi := &file_app_router_command_command_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListRuleFullRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRuleFullRequest) ProtoMessage() {}

func (x *ListRuleFullRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRuleFullRequest.ProtoReflect.Descriptor instead.
func (*ListRuleFullRequest) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{21}
}

// FullRuleItem carries the routing fields needed for snapshot/drift detection:
// the rule tag identity plus the user(email) condition and the target outbound
// it routes to. This is what reconcile compares against the backend's intended
// per-client route set.
type FullRuleItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RuleTag       string                 `protobuf:"bytes,1,opt,name=ruleTag,proto3" json:"ruleTag,omitempty"`
	OutboundTag   string                 `protobuf:"bytes,2,opt,name=outboundTag,proto3" json:"outboundTag,omitempty"`
	User          string                 `protobuf:"bytes,3,opt,name=user,proto3" json:"user,omitempty"`
	InboundTag    string                 `protobuf:"bytes,4,opt,name=inboundTag,proto3" json:"inboundTag,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FullRuleItem) Reset() {
	*x = FullRuleItem{}
...
func (x *FullRuleItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FullRuleItem) ProtoMessage() {}

func (x *FullRuleItem) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FullRuleItem.ProtoReflect.Descriptor instead.
func (*FullRuleItem) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{22}
}

func (x *FullRuleItem) GetRuleTag() string {
	if x != nil {
		return x.RuleTag
	}
	return ""
...
func (x *FullRuleItem) GetOutboundTag() string {
	if x != nil {
		return x.OutboundTag
	}
	return ""
...
func (x *FullRuleItem) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *FullRuleItem) GetInboundTag() string {
	if x != nil {
		return x.InboundTag
	}
	return ""
...
type ListRuleFullResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rules         []*FullRuleItem        `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListRuleFullResponse) Reset() {
	*x = ListRuleFullResponse{}
	mi := &file_app_router_command_command_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListRuleFullResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRuleFullResponse) ProtoMessage() {}

func (x *ListRuleFullResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRuleFullResponse.ProtoReflect.Descriptor instead.
func (*ListRuleFullResponse) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{23}
}

func (x *ListRuleFullResponse) GetRules() []*FullRuleItem {
	if x != nil {
		return x.Rules
	}
	return nil
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_app_router_command_command_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{24}
}
...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\x05rules\x18\x01 \x03(\v2%.xray.app.router.command.ListRuleItemR\x05rules\"u\n" +
	"\x13BatchAddRuleRequest\x12:\n" +
	"\aconfigs\x18\x01 \x03(\v2 .xray.common.serial.TypedMessageR\aconfigs\x12\"\n" +
	"\fshouldAppend\x18\x02 \x01(\bR\fshouldAppend\"4\n" +
	"\x16BatchRemoveRuleRequest\x12\x1a\n" +
	"\bruleTags\x18\x01 \x03(\tR\bruleTags\"`\n" +
	"\x18BatchRuleOperationResult\x12\x14\n" +
	"\x05index\x18\x01 \x01(\rR\x05index\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"`\n" +
	"\x11BatchRuleResponse\x12K\n" +
	"\aresults\x18\x01 \x03(\v21.xray.app.router.command.BatchRuleOperationResultR\aresults\"\x15\n" +
	"\x13ListRuleFullRequest\"~\n" +
	"\fFullRuleItem\x12\x18\n" +
	"\aruleTag\x18\x01 \x01(\tR\aruleTag\x12 \n" +
	"\voutboundTag\x18\x02 \x01(\tR\voutboundTag\x12\x12\n" +
	"\x04user\x18\x03 \x01(\tR\x04user\x12\x1e\n" +
	"\n" +
	"inboundTag\x18\x04 \x01(\tR\n" +
	"inboundTag\"S\n" +
	"\x14ListRuleFullResponse\x12;\n" +
	"\x05rules\x18\x01 \x03(\v2%.xray.app.router.command.FullRuleItemR\x05rules\"\b\n" +
	"\x06Config2\xef\b\n" +
	...
	"\n" +
	"RemoveRule\x12*.xray.app.router.command.RemoveRuleRequest\x1a+.xray.app.router.command.RemoveRuleResponse\"\x00\x12j\n" +
	"\fBatchAddRule\x12,.xray.app.router.command.BatchAddRuleRequest\x1a*.xray.app.router.command.BatchRuleResponse\"\x00\x12p\n" +
	"\x0fBatchRemoveRule\x12/.xray.app.router.command.BatchRemoveRuleRequest\x1a*.xray.app.router.command.BatchRuleResponse\"\x00\x12a\n" +
	"\bListRule\x12(.xray.app.router.command.ListRuleRequest\x1a).xray.app.router.command.ListRuleResponse\"\x00\x12m\n" +
	"\fListRuleFull\x12,.xray.app.router.command.ListRuleFullRequest\x1a-.xray.app.router.command.ListRuleFullResponse\"\x00Bg\n" +
...
var file_app_router_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_app_router_command_command_proto_goTypes = []any{
	...
	(*BatchAddRuleRequest)(nil),            // 17: xray.app.router.command.BatchAddRuleRequest
	(*BatchRemoveRuleRequest)(nil),         // 18: xray.app.router.command.BatchRemoveRuleRequest
	(*BatchRuleOperationResult)(nil),       // 19: xray.app.router.command.BatchRuleOperationResult
	(*BatchRuleResponse)(nil),              // 20: xray.app.router.command.BatchRuleResponse
	(*ListRuleFullRequest)(nil),            // 21: xray.app.router.command.ListRuleFullRequest
	(*FullRuleItem)(nil),                   // 22: xray.app.router.command.FullRuleItem
	(*ListRuleFullResponse)(nil),           // 23: xray.app.router.command.ListRuleFullResponse
	(*Config)(nil),                         // 24: xray.app.router.command.Config
	nil,                                    // 25: xray.app.router.command.RoutingContext.AttributesEntry
	(net.Network)(0),                       // 26: xray.common.net.Network
	(*serial.TypedMessage)(nil),            // 27: xray.common.serial.TypedMessage
}
var file_app_router_command_command_proto_depIdxs = []int32{
	26, // 0: xray.app.router.command.RoutingContext.Network:type_name -> xray.common.net.Network
	25, // 1: xray.app.router.command.RoutingContext.Attributes:type_name -> xray.app.router.command.RoutingContext.AttributesEntry
	...
	27, // 6: xray.app.router.command.AddRuleRequest.config:type_name -> xray.common.serial.TypedMessage
	15, // 7: xray.app.router.command.ListRuleResponse.rules:type_name -> xray.app.router.command.ListRuleItem
	27, // 8: xray.app.router.command.BatchAddRuleRequest.configs:type_name -> xray.common.serial.TypedMessage
	19, // 9: xray.app.router.command.BatchRuleResponse.results:type_name -> xray.app.router.command.BatchRuleOperationResult
	22, // 10: xray.app.router.command.ListRuleFullResponse.rules:type_name -> xray.app.router.command.FullRuleItem
	...
	6,  // 13: xray.app.router.command.RoutingService.GetBalancerInfo:input_type -> xray.app.router.command.GetBalancerInfoRequest
	8,  // 14: xray.app.router.command.RoutingService.OverrideBalancerTarget:input_type -> xray.app.router.command.OverrideBalancerTargetRequest
	10, // 15: xray.app.router.command.RoutingService.AddRule:input_type -> xray.app.router.command.AddRuleRequest
	12, // 16: xray.app.router.command.RoutingService.RemoveRule:input_type -> xray.app.router.command.RemoveRuleRequest
	17, // 17: xray.app.router.command.RoutingService.BatchAddRule:input_type -> xray.app.router.command.BatchAddRuleRequest
	18, // 18: xray.app.router.command.RoutingService.BatchRemoveRule:input_type -> xray.app.router.command.BatchRemoveRuleRequest
	14, // 19: xray.app.router.command.RoutingService.ListRule:input_type -> xray.app.router.command.ListRuleRequest
	21, // 20: xray.app.router.command.RoutingService.ListRuleFull:input_type -> xray.app.router.command.ListRuleFullRequest
	0,  // 21: xray.app.router.command.RoutingService.SubscribeRoutingStats:output_type -> xray.app.router.command.RoutingContext
	0,  // 22: xray.app.router.command.RoutingService.TestRoute:output_type -> xray.app.router.command.RoutingContext
	7,  // 23: xray.app.router.command.RoutingService.GetBalancerInfo:output_type -> xray.app.router.command.GetBalancerInfoResponse
	9,  // 24: xray.app.router.command.RoutingService.OverrideBalancerTarget:output_type -> xray.app.router.command.OverrideBalancerTargetResponse
	11, // 25: xray.app.router.command.RoutingService.AddRule:output_type -> xray.app.router.command.AddRuleResponse
	13, // 26: xray.app.router.command.RoutingService.RemoveRule:output_type -> xray.app.router.command.RemoveRuleResponse
	20, // 27: xray.app.router.command.RoutingService.BatchAddRule:output_type -> xray.app.router.command.BatchRuleResponse
	20, // 28: xray.app.router.command.RoutingService.BatchRemoveRule:output_type -> xray.app.router.command.BatchRuleResponse
	16, // 29: xray.app.router.command.RoutingService.ListRule:output_type -> xray.app.router.command.ListRuleResponse
	23, // 30: xray.app.router.command.RoutingService.ListRuleFull:output_type -> xray.app.router.command.ListRuleFullResponse
