...
func (r *Router) Init(ctx context.Context, config *Config, d dns.Client, ohm outbound.Manager, dispatcher routing.Dispatcher) error {
	...
	for _, rule := range config.Rule {
		...
		rr := &Rule{
			...
			InboundTag: firstString(rule.GetInboundTag()),
			User:       firstString(rule.GetUserEmail()),
		}
...
func (r *Router) ListRule() []routing.Route {
	...
	for _, rule := range r.rules {
		ruleList = append(ruleList, &Route{
			Context:     ruleSnapshotContext{inboundTag: rule.InboundTag, user: rule.User},
...
type ruleSnapshotContext struct {
	inboundTag string
	user       string
}

func (ctx ruleSnapshotContext) GetInboundTag() string            { return ctx.inboundTag }
func (ctx ruleSnapshotContext) GetSourceIPs() []net.IP           { return nil }
func (ctx ruleSnapshotContext) GetSourcePort() net.Port          { return 0 }
func (ctx ruleSnapshotContext) GetTargetIPs() []net.IP           { return nil }
func (ctx ruleSnapshotContext) GetTargetPort() net.Port          { return 0 }
func (ctx ruleSnapshotContext) GetLocalIPs() []net.IP            { return nil }
func (ctx ruleSnapshotContext) GetLocalPort() net.Port           { return 0 }
func (ctx ruleSnapshotContext) GetTargetDomain() string          { return "" }
func (ctx ruleSnapshotContext) GetNetwork() net.Network          { return 0 }
func (ctx ruleSnapshotContext) GetProtocol() string              { return "" }
func (ctx ruleSnapshotContext) GetUser() string                  { return ctx.user }
func (ctx ruleSnapshotContext) GetVlessRoute() net.Port          { return 0 }
func (ctx ruleSnapshotContext) GetAttributes() map[string]string { return nil }
func (ctx ruleSnapshotContext) GetSkipDNSResolve() bool          { return false }
