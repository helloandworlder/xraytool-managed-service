...
func (w *udpWorker) Drain() error {
	...
	if len(errs) > 0 {
		return errors.New("failed to drain UDP listener").Base(errors.New(serial.Concat(errs...)))
	}
	return nil
}
