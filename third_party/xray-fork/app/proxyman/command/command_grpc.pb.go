...
const (
	...
	HandlerService_DrainInbound_FullMethodName         = "/xray.app.proxyman.command.HandlerService/DrainInbound"
	HandlerService_ResumeInbound_FullMethodName        = "/xray.app.proxyman.command.HandlerService/ResumeInbound"
	HandlerService_AlterInbound_FullMethodName         = "/xray.app.proxyman.command.HandlerService/AlterInbound"
	HandlerService_BatchAlterInbound_FullMethodName    = "/xray.app.proxyman.command.HandlerService/BatchAlterInbound"
...
type HandlerServiceClient interface {
	...
	DrainInbound(ctx context.Context, in *DrainInboundRequest, opts ...grpc.CallOption) (*DrainInboundResponse, error)
	ResumeInbound(ctx context.Context, in *ResumeInboundRequest, opts ...grpc.CallOption) (*ResumeInboundResponse, error)
	AlterInbound(ctx context.Context, in *AlterInboundRequest, opts ...grpc.CallOption) (*AlterInboundResponse, error)
	BatchAlterInbound(ctx context.Context, in *BatchAlterInboundRequest, opts ...grpc.CallOption) (*BatchAlterInboundResponse, error)
...
func (c *handlerServiceClient) DrainInbound(ctx context.Context, in *DrainInboundRequest, opts ...grpc.CallOption) (*DrainInboundResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DrainInboundResponse)
	err := c.cc.Invoke(ctx, HandlerService_DrainInbound_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) ResumeInbound(ctx context.Context, in *ResumeInboundRequest, opts ...grpc.CallOption) (*ResumeInboundResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResumeInboundResponse)
	err := c.cc.Invoke(ctx, HandlerService_ResumeInbound_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) BatchAlterInbound(ctx context.Context, in *BatchAlterInboundRequest, opts ...grpc.CallOption) (*BatchAlterInboundResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchAlterInboundResponse)
	err := c.cc.Invoke(ctx, HandlerService_BatchAlterInbound_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HandlerServiceServer interface {
	...
	// DrainInbound closes only the listening socket. Established TCP sessions
	// keep their handler/proxy state until the old process exits after a drain TTL.
	DrainInbound(context.Context, *DrainInboundRequest) (*DrainInboundResponse, error)
	ResumeInbound(context.Context, *ResumeInboundRequest) (*ResumeInboundResponse, error)
	AlterInbound(context.Context, *AlterInboundRequest) (*AlterInboundResponse, error)
	BatchAlterInbound(context.Context, *BatchAlterInboundRequest) (*BatchAlterInboundResponse, error)
...
func (UnimplementedHandlerServiceServer) DrainInbound(context.Context, *DrainInboundRequest) (*DrainInboundResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DrainInbound not implemented")
}
func (UnimplementedHandlerServiceServer) ResumeInbound(context.Context, *ResumeInboundRequest) (*ResumeInboundResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResumeInbound not implemented")
}
...
func (UnimplementedHandlerServiceServer) BatchAlterInbound(context.Context, *BatchAlterInboundRequest) (*BatchAlterInboundResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchAlterInbound not implemented")
}
...
func _HandlerService_DrainInbound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DrainInboundRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).DrainInbound(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_DrainInbound_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).DrainInbound(ctx, req.(*DrainInboundRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HandlerService_ResumeInbound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResumeInboundRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).ResumeInbound(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_ResumeInbound_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).ResumeInbound(ctx, req.(*ResumeInboundRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HandlerService_BatchAlterInbound_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchAlterInboundRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).BatchAlterInbound(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_BatchAlterInbound_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).BatchAlterInbound(ctx, req.(*BatchAlterInboundRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HandlerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DrainInbound",
			Handler:    _HandlerService_DrainInbound_Handler,
		},
		{
			MethodName: "ResumeInbound",
			Handler:    _HandlerService_ResumeInbound_Handler,
		},
		{
		...
		{
			MethodName: "BatchAlterInbound",
			Handler:    _HandlerService_BatchAlterInbound_Handler,
		},
		{
