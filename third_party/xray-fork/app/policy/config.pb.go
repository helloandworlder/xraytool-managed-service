...
type Policy_Stats struct {
	...
	// Enable per-(user,destination-site) traffic counters. Off by default
	// because per-domain cardinality is unbounded; opt-in for site aggregation.
	UserSite      bool `protobuf:"varint,4,opt,name=user_site,json=userSite,proto3" json:"user_site,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Policy_Stats) GetUserSite() bool {
	if x != nil {
		return x.UserSite
	}
	return false
...
const file_app_policy_config_proto_rawDesc = "" +
	...
	"\x06Second\x12\x14\n" +
	"\x05value\x18\x01 \x01(\rR\x05value\"\xe5\x04\n" +
	"\x06Policy\x129\n" +
	...
	"uplinkOnly\x12<\n" +
	"\rdownlink_only\x18\x04 \x01(\v2\x17.xray.app.policy.SecondR\fdownlinkOnly\x1a\x8b\x01\n" +
	"\x05Stats\x12\x1f\n" +
	...
	"userOnline\x12\x1b\n" +
	"\tuser_site\x18\x04 \x01(\bR\buserSite\x1a(\n" +
	"\x06Buffer\x12\x1e\n" +
	"\n" +
