...
func setupOrderServiceTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.Customer{}, &model.HostIP{}, &model.DedicatedEntry{}, &model.DedicatedInbound{}, &model.DedicatedIngress{}, &model.Order{}, &model.OrderItem{}, &model.DedicatedEgress{}, &model.XrayResource{}, &model.Setting{}, &model.RuntimeSyncTask{}, &model.RuntimeTrafficSnapshot{}); err != nil {
